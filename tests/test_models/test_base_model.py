...
class test_basemodel(unittest.TestCase):
    """ It test class for base_model class"""

    def __init__(self, *args, **kwargs):
        """ init test class of basemodel"""
        super().__init__(*args, **kwargs)
        self.name = 'BaseModel'
        self.value = BaseModel

    def setUp(self):
        """ It set up method of test class"""
        pass

    def tearDown(self):
        """Teardown method of ctest class"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_init(self):
        """It tests initialization of model class.
        """
    ...
    def test_default(self):
        """ Its a default testing of basemodel"""
        i = self.value()
    ...
    def test_kwargs_int(self):
        """ It test with kwargs again but with int kwargs"""
        i = self.value()
        copy = i.to_dict()
        copy.update({1: 2})
    ...
    def test_str(self):
        """ It tests str method of themodel"""
        i = self.value()
        self.assertEqual(str(i), '[{}] ({}) {}'.format(self.name, i.id,
                         i.__dict__))

    def test_todict(self):
        """ It is testing to_dict method"""
        i = self.value()
        n = i.to_dict()
    ...
    def test_kwargs_none(self):
        """ Testing again with none"""
        n = {None: None}
        with self.assertRaises(TypeError):
            new = self.value(**n)

    def test_kwargs_one(self):
        """ It is testing kwargs"""
        n = {'name': 'test'}
        new = self.value(**n)
        self.assertEqual(new.name, n['name'])

    def test_id(self):
        """ It is testng id attr of model"""
        new = self.value()
        self.assertEqual(type(new.id), str)

    def test_created_at(self):
        """ It is testing created at attr"""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """ It is testing updated at attr"""
        new = self.value()
