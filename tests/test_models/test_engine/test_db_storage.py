#!/usr/bin/python3
''' It is the module for file_storage tests '''
import unittest
import MySQLdb
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new_and_save(self):
        ''' The test for new and saved methods'''
    ...
    def test_delete(self):
        """ Objects are correctly deleted from database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
    ...
    def test_reload(self):
        """ It test reloading of database session """
        dbc = MySQLdb.connect(
            host=os.getenv('HBNB_MYSQL_HOST'),
            port=3306,
            user=os.getenv('HBNB_MYSQL_USER'),
    ...
    def test_save(self):
        """ All objects are successfully saved - database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
