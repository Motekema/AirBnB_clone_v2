#!/usr/bin/env bash
# It sets up web servers for the deployment of web_static
...
# It adds test string
echo "<h1>Welcome to bluetapeent.tech</h1>" > /data/web_static/releases/test/index.html
echo -e "\e[1;32m Test string added\e[0m"
echo

# It prevent overwrite
