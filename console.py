...
class HBNBCommand(cmd.Cmd):
    """ Contain a functionality for the HBNB console"""
    ...
    def precmd(self, line):
        """Reformat commands line for advanced command syntax.
    ...
    def do_create(self, args):
        """ Create an object for any class"""
    ...
    def do_show(self, args):
        """ Methods to show an individual object """
        new = args.partition(" ")
        c_name = new[0]
        c_id = new[2]
