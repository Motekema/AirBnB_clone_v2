...
class DBStorage:
    ...
    def all(self, cls=None):
        ...
        If cls is None, queries all the types of objects.
    ...
    def save(self):
        """Commit all changes to a current database session."""
    ...
    def reload(self):
        """Create all tables in a database and initialize a new session."""
    ...
    def close(self):
        """Close a working SQLAlchemy session."""
